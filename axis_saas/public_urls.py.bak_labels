...
from .views.timetable import timetable_management, api_update_calendar, api_add_holiday, api_delete_holiday, api_add_period, api_delete_period, api_update_period, api_get_timetable, api_save_timetable, api_save_day_schedules, api_update_holiday
